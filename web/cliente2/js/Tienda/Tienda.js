...
function createCategoriaItn(obj) {
    ...
    html += "<label for='categoriacb" + obj.id + "'>";
        ...
        html += "<img src='../admin/" + obj.url_foto + "' alt='' style='width:auto; height:50px;' class='clear '/>";
    html +=".</label>";
    html += "</div>";
    html += "</div>";
...
function createMarcaItn(obj) {
    ...
    html += "<img src='../admin/" + obj.url_foto + "' alt='' style='width:auto; height:50px;' class='clear clearChecks'/>";
    html += "</label>";
    html += "                                            </div> ";
    html += "                                        </div>";
...
function createModeloItn(obj) {
    ...
    html += obj.nombre;
    html += "</div>";
    html += "<img src='../admin/" + obj.url_foto + "' alt='' style='width:auto; height:65px;' class='ml-auto p-2'/>";
    html += "</div>";
    return html;
}
...
function cargarIten(obj) {
    ...
    html += "                                    <a href='repuesto.html?id=" + obj.id + "'><img class='foto_rep' src='../admin/" + obj.url_foto + "' alt='1'/></a>";
