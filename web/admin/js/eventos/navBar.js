...
function cargar() {
    ...
    if (sessionStorage.getItem("usr_log")) {
        ...
        nombre = usr_log.nombre+" "+usr_log.apellido_pa+" "+usr_log.apellido_ma;
        id = usr_log.id;
    }
    ...
    html += "                            <img class='user-avatar rounded-circle' src='" + PARAMS.url_image+foto + "' alt='' >";
    html += "                        </button>";
    html += "                        <div class='dropdown-menu user-menu'>";
    html += "                            <a class='nav-link' href='UsrPerfil.html?id="+id+"'><i class='fa fa-user'></i>Mi perfil</a>";
    ...
    html += "                            <button class='btn btn-danger' onclick='cerrar_cession();' >Cerrar sesion</button>";
    html += "                        </div>";
    html += "                    </div>";
    html += "                </div>";
    html += "            </div>";
