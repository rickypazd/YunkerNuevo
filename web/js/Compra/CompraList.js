...
function Lista_repuesto() {
    ...
    $.post(url, {evento: "getComprasPagination", busqueda: busqueda, cantidad: 10, pagina: pagina, TokenAcceso: "servi12sis3"}, function (resp) {
        // cerrar_progress();
        enPedido = false;
...
function ver(itn) {
    var padre = $(itn).parent().parent().parent().parent();
    var data = $(padre).data("obj");
//    window.location.href = "#.html?id=" + data.id;
