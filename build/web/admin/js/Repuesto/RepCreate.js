...
$(document).ready(function () {
    ...
    if (idSubCat > 0) {
         ...
         alert("Primero deve selecciona la subCategoria.");
         window.location.href = "RepCategoriaList.html";
    }
...
//                    html += "                        <div class='col-4 btnAction btnEditar' onclick='editar(this);'><img src='img/lapiz.svg' alt=''/><p>Editar</p></div>";
    html += "                        <div class='col-12 btnAction btnEliminar' onclick='eliminar(this);'>  <img src='img/bote-de-basura.svg' alt=''/><p>Eliminar</p></div>";
