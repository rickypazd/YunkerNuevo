...
function Lista_repuesto() {
    ...
    $.post(url, {evento: "getVentasCuotasPagination", busqueda: busqueda,cantidad: 10, pagina: pagina, TokenAcceso: "servi12sis3"}, function (resp) {
        // cerrar_progress();
        enPedido = false;
        ...
        if (resp != null) {
            ...
            if (obj.estado != "1") {
                ...
                $.each(arr, function (i, obj) {
                    ...
                    html += "                         <h6>" + obj.cuotas_pagadas + " / "+obj.cuotas.length+"</h6>";
                    html += "                     </div>";
                    html += "                     <div class='col-1'>";
                    if((obj.cuotas_pagadas-obj.cuotas.length)==0){
                        html += "                         <h6>pagado</h6>";
                    }else{
                        
                        html += "                         <h6> Fecha de pago pendiente : </br></br> " + obj.cuota_pendiente + " </h6>";
                    }
