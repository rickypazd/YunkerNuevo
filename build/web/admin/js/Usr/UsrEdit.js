        ...
        if (resp != null) {
            ...
            if (objec.estado != "1") {
                ...
                if (sessionStorage.getItem("usr_log")) {
                    ...
                    if(usr_log.id == obj.id){
                        usr_log.nombre = obj.nombre;
                        usr_log.apellido_pa = obj.apellido_pa;
                        usr_log.apellido_ma = obj.apellido_ma;
                        usr_log.url_foto = obj.url_foto;
                        sessionStorage.setItem("usr_log",JSON.stringify(usr_log));
                    }
                }
