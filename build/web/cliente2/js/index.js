...
function cargarMarca(obj){
     ...
     html+="                           <img src='../admin/"+obj.url_foto+"' alt='1' style='max-height: 100px;' />";
     html+="                           <p>"+obj.nombre+"</p>";
     html+="                       </a>";
     html+="                   </div>";
     return html;
...
function cargarItenRepuesto(obj){
    var html = "<div class='col-lg-3 col-md-4 col-sm-6 repuestoIndex carruselIten'>";
    html+="                                <div class='tile'>";
    ...
    html+="                                        <a href='repuesto.html?id="+obj.id+"'>"+obj.nombre+"</a>";
...
//    html+="                                            </a>";
    ...
    html+="                                </div>";
    html+="                            </div>";
    document.getElementById("carruselList").innerHTML+=html;
