        ...
        if (resp != null) {
            ...
            if (obj.estado != "1") {
                ...
                $.each(json, function (i, obj) {
                    ...
                    html += "                     </div>";
                    html += "                     <div class='col-1'>";
                    html += "                         <img src='" + obj.obj.repuesto.url_foto + "' class='' height='60px' alt='' />";
                    html += "                      </div>";
...
//                    html += "                        <div class='col-4 btnAction btnEditar d-flex justify-content-center  align-items-center' onclick='editar(this);'><div><img src='img/lapiz.svg' alt=''/><p>Editar</p></div></div>";
                    ...
                    html += "                        <div class='col-4 btnAction btnEliminar d-flex justify-content-center  align-items-center' onclick='AggArticulo(this);'>  <div><img src='img/cheuron.svg' alt=''/><p>Agg</p></div></div>";
                    html += "                    </div>";
                    html += "                     </div>";
                    html += "                 </div>";
                    html += "            </div>";
